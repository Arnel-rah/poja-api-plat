...
@Component
@AllArgsConstructor
public class PojaConf4Validator implements PojaConfValidator<PojaConf4> {
  ...
  @Override
  public void accept(@Nullable PojaConf4 from, PojaConf4 to, Boolean isPremium) {
  ...
  private Set<String> invalidAttributes(PojaConf4 to, boolean isPremium) {
  ...
  public Set<String> outputIllegalTransitions(
      @Nullable PojaConf4 from, PojaConf4 to, Boolean isPremium) {
    if (from == null) {
      return Set.of();
    }
  ...
  public void accept(@Nullable PojaConf1 from, PojaConf4 to, boolean isPremium) {
  ...
  public void accept(@Nullable PojaConf2 from, PojaConf4 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf3 from, PojaConf4 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf1 from, PojaConf4 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf2 from, PojaConf4 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf3 from, PojaConf4 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
