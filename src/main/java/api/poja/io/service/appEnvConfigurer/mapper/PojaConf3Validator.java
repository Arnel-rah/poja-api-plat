...
@Component
@AllArgsConstructor
public class PojaConf3Validator implements PojaConfValidator<PojaConf3> {
  ...
  @Override
  public void accept(@Nullable PojaConf3 from, PojaConf3 to, Boolean isPremium) {
  ...
  private Set<String> invalidAttributes(PojaConf3 to, boolean isPremium) {
  ...
  public Set<String> outputIllegalTransitions(
      @Nullable PojaConf3 from, PojaConf3 to, Boolean isPremium) {
    if (from == null) {
      return Set.of();
    }
  ...
  public void accept(@Nullable PojaConf1 from, PojaConf3 to, boolean isPremium) {
  ...
  public void accept(@Nullable PojaConf2 from, PojaConf3 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf1 from, PojaConf3 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf2 from, PojaConf3 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
