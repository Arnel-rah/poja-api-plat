...
@Component
@AllArgsConstructor
public class PojaConf2Validator implements PojaConfValidator<PojaConf2> {
  ...
  @Override
  public void accept(@Nullable PojaConf2 from, PojaConf2 to, Boolean isPremium) {
    Set<String> invalidAttributes = getInvalidAttributes(to);
  ...
  private Set<String> getInvalidAttributes(PojaConf2 to) {
  ...
  public Set<String> outputIllegalTransitions(
      @Nullable PojaConf2 from, PojaConf2 to, Boolean isPremium) {
    if (from == null) {
      return Set.of();
    }
  ...
  public void accept(@Nullable PojaConf1 from, PojaConf2 to) {
    var invalidAttributes = getInvalidAttributes(to);
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf1 from, PojaConf2 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
