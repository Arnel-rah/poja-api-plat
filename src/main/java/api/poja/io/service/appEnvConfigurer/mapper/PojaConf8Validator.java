...
@Component
@AllArgsConstructor
public class PojaConf8Validator implements PojaConfValidator<PojaConf8> {
  ...
  @Override
  public void accept(@Nullable PojaConf8 from, PojaConf8 to, Boolean isPremium) {
  ...
  private Set<String> invalidAttributes(PojaConf8 to, boolean isPremium) {
    ...
    if (to.scheduledTasks() != null) {
      ...
      var scheduledTasksExceptionMessages = scheduledTasksValidator.errorMessages8(scheduledTasks);
  ...
  public Set<String> outputIllegalTransitions(
      @Nullable PojaConf8 from, PojaConf8 to, Boolean isPremium) {
    if (from == null) {
      return Set.of();
    }
  ...
  public void accept(@Nullable PojaConf1 from, PojaConf8 to, boolean isPremium) {
  ...
  public void accept(@Nullable PojaConf2 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf3 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf4 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf5 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf6 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public void accept(@Nullable PojaConf7 from, PojaConf8 to, boolean isPremium) {
    var invalidAttributes = invalidAttributes(to, isPremium);
    var illegalTransitions = outputIllegalTransitions(from, to);
    invalidAttributes.addAll(illegalTransitions);
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf1 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf2 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf3 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf4 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf5 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf6 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
  ...
  public Set<String> outputIllegalTransitions(@Nullable PojaConf7 from, PojaConf8 to) {
    if (from == null) {
      return Set.of();
    }
    Set<String> illegalTransitions = new HashSet<>();
