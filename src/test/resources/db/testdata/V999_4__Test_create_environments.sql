...
values ('poja_application_environment_id', 'PROD', false, 'poja_application_id', 'file1_conf_key.yml'),
       ...
       ('recsus_application_environment_id', 'PROD', true, 'recsus_application_id', 'file2_conf_key.yml'),
       ('jane_doe_application_environment_id', 'PROD', true, 'jane_doe_application_id', 'file2_conf_key.yml')
;
